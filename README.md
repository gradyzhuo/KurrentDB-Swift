...
# KurrentDB 
This is unofficial [Kurrent](https://www.kurrent.io/) (formerly: EventStore) Database [gRPC](https://github.com/grpc/grpc-swift-2.git) Client SDK, developing in [Swift language](https://www.swift.org/)
